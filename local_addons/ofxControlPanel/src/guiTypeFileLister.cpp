...
void guiTypeFileLister::setValue(float _value, int whichParam) {
  selection = _value;
}
...
void guiTypeFileLister::saveSettings(ofxXmlSettings& settings) {
...
void guiTypeFileLister::loadSettings(ofxXmlSettings& settings) {
